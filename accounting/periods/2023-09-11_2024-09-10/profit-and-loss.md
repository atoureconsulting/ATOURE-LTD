...
Status: **DRAFT — awaiting source data**
...
**Total expenses: £0.00** _(placeholder — to be filled in)_
...
- See `/notes.md` section 3 for the running assumptions log.
